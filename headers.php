...
<?php if ( is_single() ) { ?><?php } else { ?><?php } ?>
<?php wp_head(); ?> <?php echo get_option('hscript'); ?>
<meta name="robots" content="index,follow,noodp"/>
<meta name='revisit-after' content='1 days'/>
<meta http-equiv="refresh" content="1200"/>
<meta name="generator" content="Phap luat doi song"/>
<meta property="fb:admins" content="100001763946686"/>
<meta property="fb:app_id" content="175373182663736"/>
...
<script type="text/javascript">$(document).ready(function(){$(".tab_content").hide();$("ul.tabs li:first").addClass("active").show();$(".tab_content:first").show();$("ul.tabs li").click(function(){$("ul.tabs li").removeClass("active");$(this).addClass("active");$(".tab_content").hide();var a=$(this).find("a").attr("href");$(a).fadeIn();return false})});</script>
<script type="text/javascript">/*<![CDATA[*/$(document).ready(function(){createTicker()});function createTicker(){var a=$("#header3-1-left-ticker ul").children();tickerItems=new Array();a.each(function(b){tickerItems.push(jQuery(this).html())});i=0;rotateTicker()}function rotateTicker(){if(i==tickerItems.length){i=0}tickerText=tickerItems[i];c=0;typetext();setTimeout("rotateTicker()",5000);i++}var isInTag=false;function typetext(){var a=tickerText.substr(c,1);if(a=="<"){isInTag=true}if(a==">"){isInTag=false}$("#header3-1-left-ticker").html("&nbsp;"+tickerText.substr(0,c++));if(c<tickerText.length+1){if(isInTag){typetext()}else{setTimeout("typetext()",28)}}else{c=1;tickerText=""}}/*]]>*/</script>
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/js/slides.min.jquery.js"></script>
<script>/*<![CDATA[*/$(function(){$("#slides").slides({preload:true,play:5000,pause:2500,hoverPause:true,animationStart:function(a){$(".caption").animate({bottom:-35},100);if(window.console&&console.log){console.log("animationStart on slide: ",a)}},animationComplete:function(a){$(".caption").animate({bottom:0},200);if(window.console&&console.log){console.log("animationComplete on slide: ",a)}},slidesLoaded:function(){$(".caption").animate({bottom:0},200)}})});/*]]>*/</script>
<?php if ( is_singular() ) wp_enqueue_script( 'comment-reply' ); ?> <?php if ( is_single()){ ?> <style>#content .post{border:none!important}</style> <?php } ?>
<style media="screen" type="text/css">/*<![CDATA[*/.custom1{border-top:1px solid <?php echo of_get_option('example_colorpicker', '#000' ); ?>!important}.custom1 a{color:<?php echo of_get_option('example_colorpicker', '#000' ); ?>!important}.custom2{border-top:1px solid <?php echo of_get_option('block2color', '#000' ); ?>!important}.custom2 a{color:<?php echo of_get_option('block2color', '#000' ); ?>!important}.custom3{border-top:1px solid <?php echo of_get_option('block3color', '#000' ); ?>!important}.custom3 a{color:<?php echo of_get_option('block3color', '#000' ); ?>!important}.custom4{border-top:1px solid <?php echo of_get_option('block4color', '#000' ); ?>!important}.custom4 a{color:<?php echo of_get_option('block4color', '#000' ); ?>!important}.custom5{border-top:1px solid <?php echo of_get_option('block5color', '#000' ); ?>!important}.custom5 a{color:<?php echo of_get_option('block5color', '#000' ); ?>!important}.custom6{border-top:1px solid <?php echo of_get_option('block6color', '#000' ); ?>!important}.custom6 a{color:<?php echo of_get_option('block6color', '#000' ); ?>!important}.custom7{border-top:1px solid <?php echo of_get_option('block7color', '#000' ); ?>!important}.custom7 a{color:<?php echo of_get_option('block7color', '#000' ); ?>!important}.custom8{border-top:1px solid <?php echo of_get_option('block8color', '#000' ); ?>!important}.custom8 a{color:<?php echo of_get_option('block8color', '#000' ); ?>!important}.custom9{border-top:1px solid <?php echo of_get_option('block9color', '#000' ); ?>!important}.custom9 a{color:<?php echo of_get_option('block9color', '#000' ); ?>!important}.custom10{border-top:1px solid <?php echo of_get_option('block10color', '#000' ); ?>!important}.custom10 a{color:<?php echo of_get_option('block10color', '#000' ); ?>!important}.custom11{border-top:1px solid <?php echo of_get_option('block11color', '#000' ); ?>!important}.custom11 a{color:<?php echo of_get_option('block11color', '#000' ); ?>!important}.custom12{border-top:1px solid <?php echo of_get_option('block12color', '#000' ); ?>!important}.custom12 a{color:<?php echo of_get_option('block12color', '#000' ); ?>!important}/*]]>*/</style>
</head><body>
<?php include_once("analyticstracking.php") ?> 
<div class="top1"><a name="top"></a></div>
<div id="wrapper">
<div id="header"><div style="margin-top: -25px;"><h1 style="font-size:11px; color:#CCCCCC">Tin tuc online - Đọc báo tin tức mới 24h</h1></div>
<div id="topheaderbar">
<div id="topheaderbar-l">
<div id="topnavigation">
<?php if(get_option('editionok')!="no"):?><div id="edition"><?php echo get_option('edition'); ?></div><?php endif?><?php if(get_option('editionok')!="yes"):?><?php endif?>
<div id="nav"><div id="menu"> Tin <a href="http://kenhcf.com/scandal/" title="Scandal" target="_blank">Scandal</a> Showbiz<ul><?php wp_nav_menu( array( 'walker' => new Arrow_Walker_Nav_Menu, 'theme_location' => 'main-menu', 'container_class' => 'menu-header', 'fallback_cb'=>'primarymenu2') );?></ul></div></div>
</div>
</div>
<div id="topheaderbar-r"><?php echo date_i18n('d F, Y'); ?></div>
<div class="cb"></div>
</div>
<div id="header2">
<div id="logoleft"><a href="<?php echo get_option('home'); ?>"><img src="<?php echo get_option('logo'); ?>" alt="<?php echo get_option('logoalt'); ?>"  width="298" height="80"/></div>
...
<div id="logoright-left-cat-wrapper-left"><?php if(get_option('thumbok')!="no"):?> <?php if( has_post_thumbnail() ) { ?>
<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('singlegalthumb'); ?></a>
<?php } else { ?>
<a href="<?php the_permalink(); ?>"> <img src="<?php echo catch_that_image(); ?>" style="width:55px;height:45px" /> </a><?php } ?>
<?php endif?>
...
<input type="text" name="s" value="<?php _e("Tin mới", "nt"); ?>" onBlur="if(this.value=='')this.value='<?php _e("Tin mới", "nt"); ?>'" onFocus="if(this.value=='<?php _e("Tin mới", "nt"); ?>')this.value=''" id="s2" />
<input type="submit" value=" " id="searchsubmit" />
</form></div>
<div id="logoright-right-trending"><ul>
<li><b><?php _e("Đọc báo", "nt"); ?>:</b></li>
...
<div id="header3-1-left-tickerimg"><img src="<?php bloginfo('template_directory'); ?>/images/headlines.png" alt="Headlines" width="87" height="20"/></div>
<div id="header3-1-left-ticker"><ul><?php magazine3_ticker(); ?></ul></div>
<div class="cb"></div>
</div>
<div id="header3-1-right">
<ul>
<li style="margin-left:2px"><a href="<?php echo get_option('feedlink'); ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/rss.png" width="16" height="16"/></a></li>
<li style="margin-left:8px"><a href="<?php echo get_option('feedemail'); ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/email.png" width="16" height="16"/></a></li>
<?php if(get_option('diggok')!="yes"):?><?php endif?> <?php if(get_option('diggok')!="no"):?><li><a href="<?php echo get_option('digg'); ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/digg.png" width="16" height="16"/></a></li><?php endif?>
<?php if(get_option('fbok')!="yes"):?><?php endif?> <?php if(get_option('fbok')!="no"):?><li><a href="<?php echo get_option('fb'); ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/facebook.png" width="16" height="16"/></a> </li><?php endif?>
...
<?php if(get_option('twitterok')!="yes"):?><?php endif?> <?php if(get_option('twitterok')!="no"):?><li><a href="<?php echo get_option('twitter'); ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/twitter.png" width="16" height="16"/></a> </li><?php endif?>
...
<div id="menu2"><ul>
<li id="current-home-nav" style="float:left"><a href="<?php echo get_option('home'); ?>"></a></li>
<?php wp_nav_menu( array( 'walker' => new Arrow_Walker_Nav_Menu, 'theme_location' => 'second', 'container_class' => 'menu-header', 'fallback_cb'=>'primarymenu2') );?></ul></div>
<?php endif?>
<?php if(get_option('whitenavok')!="yes"):?><?php endif?>
<?php if(get_option('whitenavok')!="no"):?>
<div id="menu3"><ul>
<li id="current-home-nav" style="float:left">
<img src="<?php bloginfo('template_directory'); ?>/images/iconhome.jpg" alt="Headlines" width="5" height="31"/></li>
